...
├── daliuge_component_examples             # The main python package for the project
...
e.g: `cat daliuge_component_examples/VERSION` will get the project version without harming
